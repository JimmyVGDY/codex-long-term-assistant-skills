...
result = {
    ...
    "codex_compatibility_registry": "FROZEN_LEGACY (%d historical versions)" % metadata["compatibility_version_count"],
    "codex_compatibility_matrix": "NOT_APPLICABLE (Desktop-only product; no standalone CLI acceptance track)",
    "desktop_native_acceptance": "NOT_EVALUATED (separate installed Desktop and fresh-task evidence)",
    "reviewer_routing_v4": _capability_projection(capabilities["reviewer_routing_v4"]),
    "delegation_budget_v4": _capability_projection(capabilities["delegation_budget_v4"]),
    "review_state_v9_and_observation_v4": _capability_projection(capabilities["review_state_v9_and_observation_v4"]),
    "desktop_component_contract": _capability_projection(capabilities["desktop_component_contract"]),
