...
V7.12.0 将冻结兼容窗口推进到官方稳定版 Codex CLI 0.155.1，并保留十档独立复审组合、基础安装与可选增强分离等既有边界。发布状态以 GitHub Release 和工作流读回为准。
...
V7.12.0 窗口为 `0.155.1`、`0.155.0`、`0.154.0`、`0.153.4`、`0.153.3`、`0.153.2`、`0.153.1`、`0.153.0`、`0.152.1`、`0.152.0`、`0.151.0`。补丁发行独立计数；未来版、预发布版和窗口外版本不会自动接纳。
