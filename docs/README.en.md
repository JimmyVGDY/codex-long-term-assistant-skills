...
This page organizes the V7.4.0 documentation by adoption stage. Historical reports and build metadata are grouped by version while preserving validation paths, references, and reproducibility evidence.
...
- [V7.4.0 package validation report](releases/v7.4.0/VALIDATION_REPORT.en.md)
- [V7.4.0 audit report](releases/v7.4.0/AUDIT_REPORT.en.md)

## Release and history

- [Release evidence index](releases/README.en.md)
- [V7.4.0 release notes](releases/v7.4.0/RELEASE_NOTES.en.md)
