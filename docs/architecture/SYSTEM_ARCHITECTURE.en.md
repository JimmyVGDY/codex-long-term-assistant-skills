...
# V7.10 Current System Architecture and Security Boundaries

> Status: `active`. This page describes the current V7.10.0 package architecture. Earlier design and release evidence is retained only for historical traceability.
...
The package version is V7.10.0. Names such as `TaskOutcomeEvent V3`, Operation v2, and Evolution Policy identify component contracts or data formats; they do not mean an older package is installed.
