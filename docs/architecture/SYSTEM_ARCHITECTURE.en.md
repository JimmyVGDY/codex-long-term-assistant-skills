...
# V7.12 Current System Architecture and Security Boundaries
...
The package version is V7.12.0. Names such as `TaskOutcomeEvent V3`, Operation v2, and Evolution Policy identify component contracts or data formats; they do not mean an older package is installed.
