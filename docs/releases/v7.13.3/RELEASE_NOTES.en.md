<!-- Generated from locales/en/docs/releases/v7.13.3/RELEASE_NOTES.md; edit that source and run scripts/documentation.py sync. -->
...
The path correction does not establish enforced native dispatch accounting or model qualification. Full validation, installation, native callbacks, public assets, and provenance require separate acceptance. See the [validation record](VALIDATION_REPORT.en.md) and [inspection record](AUDIT_REPORT.en.md).
