...
- original-chain verification, safe projection, and schema separation for Event V2/V3 and Budget V1/V2;
- model-identity privacy boundaries in Hooks, Reviewer, Evolution, and release artifacts;
- V7.4.2 upgrade, existing-state migration, installation rollback, and compatibility-window regression;
- tests, bilingual documentation, reproducible builds, Git, and release authorization boundaries.
