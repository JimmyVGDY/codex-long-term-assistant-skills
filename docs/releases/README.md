...
| --- | --- | --- | --- | --- | --- | --- |
| 7.8.0 | [Notes](v7.8.0/RELEASE_NOTES.md) | [Audit](v7.8.0/AUDIT_REPORT.md) | [Validation](v7.8.0/VALIDATION_REPORT.md) | 419 package + 205 runtime 本地候选通过；公开发布、匿名下载和账户生效分列读回 | [JSON](v7.8.0/BUILD_INFO.json) | [JSON](v7.8.0/PACKAGE_VALIDATION.json) |
