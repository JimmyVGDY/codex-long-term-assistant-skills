...
V7.5.0 是当前版本，主题为“自观察反馈与优化收益闭环”。下表中的其他版本仅用于发行追溯；其详情页会显示历史资料提示并从默认站内搜索排除，不能作为当前安装或操作说明。
...
| --- | --- | --- | --- | --- | --- | --- |
| 7.5.0 | [Notes](v7.5.0/RELEASE_NOTES.md) | [Audit](v7.5.0/AUDIT_REPORT.md) | [Validation](v7.5.0/VALIDATION_REPORT.md) | 本地完整验证、逻辑只读复审及安装链路通过；远端发行证据独立读回 | [JSON](v7.5.0/BUILD_INFO.json) | [JSON](v7.5.0/PACKAGE_VALIDATION.json) |
...
| 7.4.2 | [查看](v7.4.2/RELEASE_NOTES.md) | [查看](v7.4.2/AUDIT_REPORT.md) | [查看](v7.4.2/VALIDATION_REPORT.md) | Windows/Ubuntu 11 版本矩阵、包级验证、账户安装与 Codex 0.153.2 真实父子 Agent 验收通过 | [JSON](v7.4.2/BUILD_INFO.json) | [JSON](v7.4.2/PACKAGE_VALIDATION.json) |
