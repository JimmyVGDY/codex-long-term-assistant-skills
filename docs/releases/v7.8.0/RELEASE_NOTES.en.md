<!-- Generated from locales/en/docs/releases/v7.8.0/RELEASE_NOTES.md; edit that source and run scripts/documentation.py sync. -->

# V7.8.0 Release Notes

This release makes direct use with conditionally available enhancements an executable contract while preserving V7.6.2 message neutrality and the V7.7.0 Operation v2 write boundary.
