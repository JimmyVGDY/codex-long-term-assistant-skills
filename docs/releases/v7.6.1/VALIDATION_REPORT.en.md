<!-- Generated from locales/en/docs/releases/v7.6.1/VALIDATION_REPORT.md; edit that source and run scripts/documentation.py sync. -->
...
| Links and bilingual coverage | 614 Markdown files and 989 internal links passed; not every external website was checked |
