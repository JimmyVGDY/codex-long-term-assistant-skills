...
> Status: `active`. This page describes the current V7.7.1 package architecture. Earlier design and release evidence is retained only for historical traceability.
...
The package version is V7.7.1. Names such as `TaskOutcomeEvent V3`, Operation v2, and Evolution Policy identify component contracts or data formats; they do not mean an older package is installed.
