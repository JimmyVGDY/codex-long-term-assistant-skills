# Skill Automatic Trigger and Composition Matrix

> Status: `active`. This page describes current package routing only. Earlier source versions and migration mappings do not define current behavior.
