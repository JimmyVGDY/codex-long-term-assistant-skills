...
This page organizes the V7.2.0 documentation by adoption stage. Historical reports and build metadata are grouped by version to preserve validation paths, historical references, and reproducibility.
...
- [V7.2 user guide](USER_GUIDE_V7.2.md)
...
- [V7.2 current system architecture](SYSTEM_ARCHITECTURE.md)
...
- [V7.2.0 package validation report](releases/v7.2.0/VALIDATION_REPORT.md)
- [V7.2.0 audit report](releases/v7.2.0/AUDIT_REPORT.md)

## Release and history

- [Release evidence index](releases/README.md)
- [V7.2.0 release notes](releases/v7.2.0/RELEASE_NOTES.md)
