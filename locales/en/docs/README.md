...
This page organizes the V7.4.5 documentation by adoption stage. Historical reports and build metadata are grouped by version to preserve validation paths, historical references, and reproducibility.
...
- [V7.4.5 package validation report](releases/v7.4.5/VALIDATION_REPORT.md)
- [V7.4.5 audit report](releases/v7.4.5/AUDIT_REPORT.md)

## Release and history

- [Release evidence index](releases/README.md)
- [V7.4.5 release notes](releases/v7.4.5/RELEASE_NOTES.md)
