...
> Status: `active`. This page describes current V7.4.5 behavior. `5.1.0` in the Evolution component manifest and the default policy `v6.5-default-1` are internal contract versions.
...
The current V7.4.5 package continues to use these foundational execution contracts:
