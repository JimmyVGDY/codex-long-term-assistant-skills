# V7.3 Controlled Evolution Operations Manual

> Status: `active`. This page applies to V7.3.0. The Evolution component manifest still uses contract version `5.1.0`, and the default policy is `v6.5-default-1`; neither value is the current package version.
