...
| --- | --- | --- | --- | --- | --- | --- |
| 7.8.0 | [Notes](v7.8.0/RELEASE_NOTES.md) | [Audit](v7.8.0/AUDIT_REPORT.md) | [Validation](v7.8.0/VALIDATION_REPORT.md) | After the Codex 0.154.0 compatibility integration, 421 package + 205 runtime local candidate tests passed; public release, anonymous download, and active-account effectiveness remain separate | [JSON](v7.8.0/BUILD_INFO.json) | [JSON](v7.8.0/PACKAGE_VALIDATION.json) |
