...
| --- | --- | --- | --- | --- | --- | --- |
| 7.12.0 | [Notes](v7.12.0/RELEASE_NOTES.md) | [Audit](v7.12.0/AUDIT_REPORT.md) | [Validation](v7.12.0/VALIDATION_REPORT.md) | Candidate: F06 focused evidence and F04 local samples are recorded; F01/F02/F03, complete validation, remote matrices, account installation, and public publication remain pending | [JSON](v7.12.0/BUILD_INFO.json) | [JSON](v7.12.0/PACKAGE_VALIDATION.json) |
| 7.11.2 | [Notes](v7.11.2/RELEASE_NOTES.md) | [Audit](v7.11.2/AUDIT_REPORT.md) | [Validation](v7.11.2/VALIDATION_REPORT.md) | Official Codex CLI 0.155.1 artifact and source contracts, the isolated Windows cell, and 563 package + 231 runtime package validation pass; remote matrix, account installation, and public publication remain separate readbacks | [JSON](v7.11.2/BUILD_INFO.json) | [JSON](v7.11.2/PACKAGE_VALIDATION.json) |
| 7.8.1 | [Notes](v7.8.1/RELEASE_NOTES.md) | [Audit](v7.8.1/AUDIT_REPORT.md) | [Validation](v7.8.1/VALIDATION_REPORT.md) | Fixes managed AGENTS block inventory hash false drift; 423 package + 205 runtime local candidate tests passed | [JSON](v7.8.1/BUILD_INFO.json) | [JSON](v7.8.1/PACKAGE_VALIDATION.json) |
| 7.8.0 | [Notes](v7.8.0/RELEASE_NOTES.md) | [Audit](v7.8.0/AUDIT_REPORT.md) | [Validation](v7.8.0/VALIDATION_REPORT.md) | After Codex 0.154.0 compatibility integration and the Windows path-alias fix, 422 package + 205 runtime local candidate tests passed; public release, anonymous download, and active-account effectiveness remain separate | [JSON](v7.8.0/BUILD_INFO.json) | [JSON](v7.8.0/PACKAGE_VALIDATION.json) |
...
| 7.7.0 | [Notes](v7.7.0/RELEASE_NOTES.md) | [Audit](v7.7.0/AUDIT_REPORT.md) | [Validation](v7.7.0/VALIDATION_REPORT.md) | 327 package + 179 runtime and round-two review pass; publication and installed readback remain separate | [JSON](v7.7.0/BUILD_INFO.json) | [JSON](v7.7.0/PACKAGE_VALIDATION.json) |
