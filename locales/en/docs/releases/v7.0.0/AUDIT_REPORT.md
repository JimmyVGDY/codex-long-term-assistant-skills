...
Chinese: [Chinese documentation](https://jimmyvgdy.github.io/codex-long-term-assistant-skills/zh-CN/docs/releases/v7.0.0/AUDIT_REPORT/)
...
- Real Codex implicit triggering: 4 representative scenarios PASS; see [Real implicit-trigger observation](IMPLICIT_TRIGGER_OBSERVATION.md)
