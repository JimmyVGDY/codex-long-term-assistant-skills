...
- The full regression passed 218 package tests and 6 runtime tests. Reproducible bilingual builds, runtime localization coverage, and 533 links across 494 tracked Markdown files also passed.
