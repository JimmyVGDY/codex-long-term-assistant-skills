...
Package validation and the complete local installation passed. All 129 package tests, 6 runtime tests, and 45 Skill-routing cases passed, together with semantic lint, strict localization, Markdown-link, and payload-manifest checks. Chinese and English release archives each produced byte-identical results across two clean builds.
