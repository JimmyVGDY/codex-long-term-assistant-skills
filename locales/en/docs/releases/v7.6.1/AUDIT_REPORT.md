...
Index candidates provide location evidence only; a gate PASS does not approve semantic reuse. Unverified hosts and platforms are not marked passed. The first complete-package command's two failures, repairs and reruns remain in the [validation record](VALIDATION_REPORT.md).
