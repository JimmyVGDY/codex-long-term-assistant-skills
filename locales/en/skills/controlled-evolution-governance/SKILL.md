...
7. Automatic Reviewer routing stops at Terra High. Runtime model status remains `UNAVAILABLE` unless a trusted host attestation is correlated to the Hook event.
