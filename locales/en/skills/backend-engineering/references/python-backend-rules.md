# Python Web, Async, and Worker Backend Stack Index

> This index adds Python runtime, Web, async, and Worker specifics. `$ai-engineering` owns model, RAG, agent, and AI-evaluation semantics. Load only the sections needed now.
...
| `python-concurrency-deployment.md` | Sync/async execution, GIL, multiprocessing, and deployment | Event loops, threads/processes, CPU work, Python AI-SDK mechanics, and Web deployment |
