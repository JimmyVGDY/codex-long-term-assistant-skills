...
| Version | Status |
| --- | --- |
| <!-- cp-fact:package-version -->7.13.3<!-- /cp-fact --> | Currently maintained |
| 7.6.0 | Earlier maintenance line; upgrade to the current release recommended |
| 7.4.4 | Security fixes only |
| 7.4.3 | Security fixes only |
| 7.4.2 | Security fixes only |
| 7.4.1 | Security fixes and upgrade support |
| 7.3.0 | Security fixes and upgrade support |
