...
CANONICAL_ENTRYPOINTS = {
    ...
    "C14": ["runtime/cp_runtime/delegation_budget.py", "scripts/delegation-budget.py", "runtime/cp_runtime/budget_v4.py", "scripts/routing-v4.py"],
    ...
    "C21": ["config/desktop-host-contract-v1.json", "scripts/desktop_host.py", "scripts/package_manager.py"],
