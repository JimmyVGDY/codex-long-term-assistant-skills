...
rem 中文：Codex 0.150.1 可能以精简 PATH 启动 Windows Hook，先定位账户级 CPython，再回退到 PATH 或 py.exe。
rem English: Codex 0.150.1 may launch Windows Hooks with a reduced PATH; resolve account-local CPython before falling back to PATH or py.exe.
