...
class V64ReleaseTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.artifact = cls.root / "Codex-Skills-V7.4.1-zh-CN.zip"
    ...
    def evidence(self):
        ...
        package = {"ok": True, "version": "7.4.1"}
        witness = {"ok": True, "reproducible": True, "version": "7.4.1",
        ...
        plugin = {"installed": [{"pluginId": "codex-cross-project-engineering-assistant@cp-assistant-local",
                                  ...
                                  "marketplaceName": "cp-assistant-local", "version": "7.4.1",
