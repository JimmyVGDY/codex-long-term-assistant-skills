...
class V64ReleaseTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.artifact = cls.root / "Codex-Skills-V7.5.0-zh-CN.zip"
    ...
    def evidence(self):
        ...
        package = {"ok": True, "version": "7.5.0"}
        witness = {"ok": True, "reproducible": True, "version": "7.5.0",
        ...
        plugin = {"installed": [{"pluginId": "codex-cross-project-engineering-assistant@cp-assistant-local",
                                  ...
                                  "marketplaceName": "cp-assistant-local", "version": "7.5.0",
    ...
    def test_manifest_schema_metadata_matches_current_runtime_contracts(self) -> None:
        ...
        build_info = json.loads(
            (ROOT / "docs" / "releases" / "v7.5.0" / "BUILD_INFO.json").read_text(encoding="utf-8")
        )
