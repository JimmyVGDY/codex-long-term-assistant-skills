#!/usr/bin/env python3
"""中文：V7.13.2 稳定版兼容注册表契约测试。

English: V7.13.2 stable-release compatibility registry contract tests.
"""
...
EXPECTED_VERSIONS = [
    "0.156.1", "0.156.0", "0.155.1", "0.155.0", "0.154.0", "0.153.4", "0.153.3", "0.153.2",
    "0.153.1", "0.153.0", "0.152.1",
]
...
class RegistryTests(unittest.TestCase):
    def setUp(self) -> None:
        self.registry = load_registry(REGISTRY_PATH, "7.13.2")
    ...
    def test_registry_is_exact_frozen_stable_window(self) -> None:
        ...
        self.assertEqual("0.156.1", self.registry["window_policy"]["anchor"])
    ...
    def test_departed_0_152_0_is_not_silently_accepted(self) -> None:
        with self.assertRaises(CompatibilityError):
            profile_for_version(self.registry, "0.152.0")
    ...
    def test_unknown_and_prerelease_versions_fail_closed(self) -> None:
        ...
        for exited in ("0.150.0", "0.149.1", "0.149.0", "0.148.0", "0.147.0", "0.146.1"):
