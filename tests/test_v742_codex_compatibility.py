#!/usr/bin/env python3
"""中文：V7.13.4 稳定版兼容注册表契约测试。

English: V7.13.4 stable-release compatibility registry contract tests.
"""
...
class RegistryTests(unittest.TestCase):
    def setUp(self) -> None:
        self.registry = load_registry(REGISTRY_PATH, "7.13.4")
    ...
    def test_registry_is_exact_frozen_stable_window(self) -> None:
        ...
        self.assertEqual("0.157.0", self.registry["window_policy"]["anchor"])
    ...
    def test_departed_0_152_1_is_not_silently_accepted(self) -> None:
        with self.assertRaises(CompatibilityError):
            profile_for_version(self.registry, "0.152.1")
