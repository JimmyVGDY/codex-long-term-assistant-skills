...
class V73BilingualReleaseTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        for locale in ("zh-CN", "en"):
            archive = cls.root / ("Codex-Skills-V7.9.0-%s.zip" % locale)
        ...
        cls.english_root = cls.english_root / "Codex-Skills-V7.9.0-en"
    ...
    def _entries(self, locale: str):
        root = "Codex-Skills-V7.9.0-%s/" % locale
    ...
    def test_two_archives_are_reproducible_distinct_and_locale_bound(self) -> None:
        ...
        for locale in ("zh-CN", "en"):
            ...
            self.assertEqual("7.9.0", json.loads(entries["manifest.json"])["version"])
            self.assertEqual("7.9.0", json.loads(entries[".codex-plugin/plugin.json"])["version"])
    ...
    def test_english_primary_surfaces_are_english_and_overlay_sources_are_not_shipped(self) -> None:
        ...
        primary = ["README.md", "CHANGELOG.md", "global/AGENTS.md",
                   "docs/releases/v7.9.0/RELEASE_NOTES.md",
                   "docs/releases/v7.9.0/VALIDATION_REPORT.md",
                   "docs/releases/v7.9.0/AUDIT_REPORT.md",
    ...
    def test_repository_root_is_compact_and_release_evidence_is_versioned(self) -> None:
        ...
        current = ROOT / "docs" / "releases" / "v7.9.0"
    ...
    def test_localization_audit_excludes_distribution_artifacts(self) -> None:
        ...
        completed = subprocess.CompletedProcess(
            args=[], returncode=0,
            stdout=b"README.md\0dist/package-validation-v7.9.0.json\0")
