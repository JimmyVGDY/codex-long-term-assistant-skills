...
| --- | --- | --- | --- |
| Native Windows Codex CLI 0.153.2 + Plugin | Real-host anchor | User-level reinstall, three-way payload readback, and the read-only parent/child Agent lifecycle pass | Actual-model and seal evidence remain `UNAVAILABLE` |
